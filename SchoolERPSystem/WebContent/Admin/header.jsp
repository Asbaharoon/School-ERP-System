...
<!-- Mirrored from www.radiustheme.com/demo/html/psdboss/akkhor/akkhor/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 11 Jun 2019 10:15:39 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>ERP School Management System || Home :: Admin</title>
               ...
               <div class="mobile-sidebar-header d-md-none">
                ...
                <div class="sidebar-menu-content">
                    <ul class="nav nav-sidebar-menu sidebar-toggle-view">
                        <li class="nav-item">
                            <a href="index.jsp" class="nav-link"><i class="flaticon-dashboard"></i><span>Dashboard</span></a>
                        ...
                        <li class="nav-item sidebar-nav-item">
                            ...
                            <ul class="nav sub-group-menu">
                                <li class="nav-item">
                                    <a href="all-student.html" class="nav-link"><i class="fas fa-angle-right"></i>View
                                        Students</a>
                                </li>
                        ...
                        <li class="nav-item sidebar-nav-item">
                            ...
                            <ul class="nav sub-group-menu">
                                <li class="nav-item">
                                    <a href="all-teacher.html" class="nav-link"><i class="fas fa-angle-right"></i>View
                                        Staff</a>
                                </li>
                               <!--  <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a href="add-staff.jsp" class="nav-link"><i class="fas fa-angle-right"></i>Add
                                        Staff</a>
                                </li>
                                <li class="nav-item">
                                    <a href="teacher-payment.html" class="nav-link"><i
                                            class="fas fa-angle-right"></i>View Salary</a>
                                </li>
                            </ul>
                        </li>
                      <!--   <li class="nav-item sidebar-nav-item">
                        ...
                        --> <li class="nav-item sidebar-nav-item">
                            <a href="#" class="nav-link"><i class="flaticon-books"></i><span>Librarian</span></a>
                            <ul class="nav sub-group-menu">
                                <li class="nav-item">
                                    <a href="all-book.html" class="nav-link"><i class="fas fa-angle-right"></i>View
                                        Book</a>
                                </li>
                                <li class="nav-item">
                        ...
                        <li class="nav-item sidebar-nav-item">
                            ...
                            <ul class="nav sub-group-menu">
                                <li class="nav-item">
                                    <a href="all-fees.html" class="nav-link"><i class="fas fa-angle-right"></i>View Fees
                                        Collection</a>
                                </li>
                               <!--  <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a href="add-fees.jsp" class="nav-link"><i class="fas fa-angle-right"></i>Add
                                        Fees </a>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-item sidebar-nav-item">
                            ...
                            <ul class="nav sub-group-menu">
                                ...
                                <li class="nav-item">
                                    <a href="add-section.jsp" class="nav-link"><i class="fas fa-angle-right"></i>Add New
                                        Section</a>
                                </li>
                                <li class="nav-item">
                         ...
                         <li class="nav-item sidebar-nav-item">
                            <a href="#" class="nav-link"><i
                                    class="flaticon-maths-class-materials-cross-of-a-pencil-and-a-ruler"></i><span>Time-Table</span></a>
                            <ul class="nav sub-group-menu">
                       ...
                       <!--  <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a href="messaging.html" class="nav-link"><i
                                    class="flaticon-chat"></i><span>Leave Request</span></a>
                        </li>
                        <li class="nav-item sidebar-nav-item">
                            <a href="#" class="nav-link"><i class="flaticon-menu-1"></i><span>Result</span></a>
                            <ul class="nav sub-group-menu">
                                <li class="nav-item">
