			...
			<form class="new-added-form">
				<div class="row">
					<div class="col-xl-4 col-lg-6 col-12 form-group">
						<label>Exam-Type *</label> <select class="select2">
					...
					<div class="col-xl-4 col-lg-6 col-12 form-group">
						<label>Student *</label> <select class="select2">
							<option value="">Please Select Class *</option>
							<option value="1">Play</option>
							<option value="2">Nursery</option>
							<option value="3">One</option>
					...
					<div class="col-xl-4 col-lg-6 col-12 form-group">
						<label>Subject1 *</label> <select class="select2">
							<option value="">Please Select Class *</option>
							<option value="1">Play</option>
							<option value="2">Nursery</option>
							<option value="3">One</option>
					...
					<div class="col-xl-4 col-lg-6 col-12 form-group">
						<label>Subject2 *</label> <select class="select2">
							<option value="">Please Select Class *</option>
							<option value="1">Play</option>
							<option value="2">Nursery</option>
							<option value="3">One</option>
					...
					<div class="col-xl-4 col-lg-6 col-12 form-group">
						<label>Subject3 *</label> <select class="select2">
							<option value="">Please Select Class *</option>
							<option value="1">Play</option>
							<option value="2">Nursery</option>
							<option value="3">One</option>
					...
					<div class="col-xl-4 col-lg-6 col-12 form-group">
						<label>Subject4 *</label> <select class="select2">
							<option value="">Please Select Class *</option>
							<option value="1">Play</option>
							<option value="2">Nursery</option>
							<option value="3">One</option>
					...
					<div class="col-xl-4 col-lg-6 col-12 form-group">
						<label>Subject5 *</label> <select class="select2">
							<option value="">Please Select Class *</option>
							<option value="1">Play</option>
							<option value="2">Nursery</option>
							<option value="3">One</option>
					...
					<div class="col-xl-4 col-lg-6 col-12 form-group">
						<label> Total-Mark *</label> <input type="text" placeholder=""
							class="form-control">
					</div>
					<div class="col-xl-4 col-lg-6 col-12 form-group">
						<label> average *</label> <input type="text" placeholder=""
							class="form-control">
					</div>
					<div class="col-xl-4 col-lg-6 col-12 form-group">
						<label> parcentage *</label> <input type="text" placeholder=""
							class="form-control">
					</div>
					<div class="col-xl-4 col-lg-6 col-12 form-group">
						<label> grade *</label> <input type="text" placeholder=""
							class="form-control">
					</div>
