...
<html>
<head>
<meta charset="ISO-8859-1"><%@ include file="header.jsp"%>
			...
			<form class="new-added-form">
				<div class="row">
					<div class="col-xl-4 col-lg-6 col-12 form-group">
						<label>Type  *</label> <select class="select2">
					...
					<div class="col-xl-4 col-lg-6 col-12 form-group">
					 ...
					 <div class="col-lg-6 col-12 form-group mg-t-30">
						<label class="text-dark-medium">Upload TimeTable Image
