			...
			<form class="new-added-form">
				...
				<div class="row">
					<div class="col-xl-4 col-lg-6 col-12 form-group">
						<label>Enrollment Roll</label> <input type="text" placeholder=""
							class="form-control">
					</div>
					<div class="col-xl-4 col-lg-6 col-12 form-group">
					...
					<div class="col-lg-6 col-12 form-group mg-t-30">
						<label class="text-dark-medium">Upload Student Photo
							(150px X 150px)</label> <input type="file" class="form-control-file">
					</div>
					<div class="col-lg-6 col-12 form-group mg-t-30">
						<label class="text-dark-medium">Upload Student Proof
							(150px X 150px)</label> <input type="file" class="form-control-file">
					</div>
